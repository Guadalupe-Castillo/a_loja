...
```bash
nodemon ./produto.js localhost 8080
```
...
```bash
nodemon --watch app --watch libs app/produto.js
```
...
```bash
nodemon --delay 10 produto.js
```

For more precision, milliseconds can be specified.  Either as a float:

```bash
nodemon --delay 2.5 produto.js
```

Or using the time specifier (ms):

```bash
nodemon --delay 2500ms produto.js
```
...
```bash
nodemon --signal SIGHUP produto.js
```
